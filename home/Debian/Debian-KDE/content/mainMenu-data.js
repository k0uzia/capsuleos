...
const MENU_APPS = [
    { catId: 'favorites', icon: '../../../usr/share/capsuleos/linux/media/img/apps/firefox.png', name: 'Firefox', desc: 'Navigateur Web', dataLink: 'firefox' },
    ...
    { catId: 'internet', icon: '../../../usr/share/capsuleos/linux/media/img/apps/firefox.png', name: 'Firefox ESR', desc: 'Navigateur Web', dataLink: 'firefox' },
