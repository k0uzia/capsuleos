const MENU_CATS = [
    ...
    { id: 'help', label: 'Aide', icon: './assets/images/toolkits/kde/category/mono-system.svg', decorative: true, disabled: true },
...
const MENU_APPS = [
    ...
    { catId: 'system', icon: './assets/images/vendors/neon/neon-logo.svg', name: 'À propos — KDE neon', desc: 'Infos distro', dataLink: 'profile' },
    { catId: 'system', icon: './assets/icons/kde/nemo/checkbox.svg', name: 'Missions KDE neon', desc: 'Missions de découverte', dataLink: 'checklist' },
