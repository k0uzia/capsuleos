(function attachMainMenuKdeChrome() {
    ...
    const FLYOUT_ID = 'mx-kde-menu-apps-flyout';
    const FLYOUT_OPEN_CLASS = 'mx-kde-menu-apps-flyout--open';
    ...
    function positionAndSizeFlyout(menuEl, flyout) {
        ...
        const mx = document.getElementById('mx-kde');
        const menuRect = menuEl.getBoundingClientRect();
        const rootFont = parseFloat(getComputedStyle(document.documentElement).fontSize) || 16;
        const gapStr = mx ? getComputedStyle(mx).getPropertyValue('--mx-kde-menu-apps-flyout-gap').trim() : '0.22rem';
        ...
        const minHStr = mx
            ? getComputedStyle(mx).getPropertyValue('--mx-kde-menu-apps-flyout-min-height').trim()
            : '5.25rem';
    ...
    function ensureAppsFlyoutReparent(menuRoot, menuEl) {
        ...
        flyout.id = FLYOUT_ID;
        flyout.className = 'mx-kde-menu-apps-flyout';
