...
| **Portail / normes conformité** | `index.html`, `.htaccess`, hubs `OS/`, `mnt/`, `REUSE.toml` | [audit-conformite-normes.md](audit-conformite-normes.md) | `validate-schema-org.mjs`, `validate-owasp-static.mjs`, `validate-reuse-full.mjs`, `validate-a11y.mjs` | `lab/smoke-a11y-portal.mjs` ; OWASP smoke curl si URL prod |
