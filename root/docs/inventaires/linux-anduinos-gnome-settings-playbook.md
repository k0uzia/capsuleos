# Playbook Paramètres GNOME — linux-anduinos

> Généré : 2026-06-17T10:35:42.665826+00:00
...
| Contrôle | VM (gsettings) | Capsule attendu |
|----------|----------------|-----------------|
| wallpaper | `'file:///usr/share/backgrounds/new_mountain-light.png'` | `file:///usr/share/backgrounds/new_mountain-light.png` |
...
| Contrôle | VM (gsettings) | Capsule attendu |
|----------|----------------|-----------------|
| contrast | `'Fluent-round-Dark'` | `normal` |
| font-scale | `1.0` | `100` |
