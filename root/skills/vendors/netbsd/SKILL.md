---
name: capsuleos-vendor-netbsd
description: CapsuleOS vendor netbsd — distributions netbsd. Use when working on netbsd branding, assets vendors/netbsd, or any netbsd simulated OS entry.
---
...
- [`netbsd`](../distributions/netbsd/SKILL.md) — skill `capsuleos-distro-netbsd`
...
- Pack vendor : `usr/share/capsuleos/assets/images/vendors/netbsd/`
