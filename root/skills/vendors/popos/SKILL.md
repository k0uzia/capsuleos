---
name: capsuleos-vendor-popos
description: CapsuleOS vendor popos — distributions linux-popos. Use when working on popos branding, assets vendors/popos, or any popos simulated OS entry.
---
...
- [`linux-popos`](../distributions/linux-popos/SKILL.md) — skill `capsuleos-distro-linux-popos`
...
- Pack vendor : `usr/share/capsuleos/assets/images/vendors/popos/`
