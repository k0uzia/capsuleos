#!/usr/bin/env node
/**
 * Captures PNG du skin Fedora CapsuleOS (Playwright) pour passe visuelle shell GNOME 50.
 * Usage : CAPSULE_HTTP_BASE=http://127.0.0.1:8765 node root/tools/lab/capture-capsule-fedora.mjs [dest-dir]
 */
import fs from 'fs';
...
const DEST = process.argv[2] || path.join(ROOT, 'usr/share/capsuleos/assets/images/vendors/fedora/inventory/fedora-capsule');
const BASE = (process.env.CAPSULE_HTTP_BASE || 'http://127.0.0.1:8765').replace(/\/$/, '');
const URL = process.env.CAPSULE_FEDORA_URL || `${BASE}/home/RedHat/Fedora/index.html`;
...
const main = async () => {
  ...
  await page.waitForFunction(
    () => document.getElementById('fedora') && document.querySelector('.fedora-overview'),
    null,
    { timeout: 60000 },
  );

  const shots = [
    { file: 'fedora-capsule-dark-desktop.png', theme: 'dark' },
    { file: 'fedora-capsule-dark-overview.png', theme: 'dark', overview: 'workspace' },
    {
      file: 'fedora-capsule-dark-overview-busy.png',
      theme: 'dark',
      slots: ['firefox'],
      focus: 'firefox',
      overview: 'workspace',
    ...
    { file: 'fedora-capsule-dark-overview-apps.png', theme: 'dark', overview: 'apps' },
    { file: 'fedora-capsule-dark-quick-settings.png', theme: 'dark', quickSettings: true },
    { file: 'fedora-capsule-dark-nautilus.png', theme: 'dark', slots: ['nemo'], focus: 'nemo' },
    { file: 'fedora-capsule-dark-firefox.png', theme: 'dark', slots: ['firefox'], focus: 'firefox' },
    { file: 'fedora-capsule-dark-text-editor.png', theme: 'dark', slots: ['text_editor'], focus: 'text_editor' },
    { file: 'fedora-capsule-dark-calculator.png', theme: 'dark', slots: ['calculator'], focus: 'calculator' },
    { file: 'fedora-capsule-dark-profile.png', theme: 'dark', slots: ['profile'], focus: 'profile' },
    {
      file: 'fedora-capsule-dark-settings-appearance.png',
      theme: 'dark',
      slots: ['themes'],
      focus: 'themes',
    ...
    {
      file: 'fedora-capsule-dark-settings-background.png',
      theme: 'dark',
      slots: ['themes'],
      focus: 'themes',
    ...
    {
      file: 'fedora-capsule-dark-settings-displays.png',
      theme: 'dark',
      slots: ['themes'],
      focus: 'themes',
      settingsPanel: 'displays',
    },
    { file: 'fedora-capsule-light-desktop.png', theme: 'light' },
    { file: 'fedora-capsule-light-overview.png', theme: 'light', overview: 'workspace' },
    { file: 'fedora-capsule-light-firefox.png', theme: 'light', slots: ['firefox'], focus: 'firefox' },
    { file: 'fedora-capsule-light-nautilus.png', theme: 'light', slots: ['nemo'], focus: 'nemo' },
  ];
