...
const EXEC_LINK = {
    ...
    'kdeconnect-indicator': 'profile',
    'kdeconnect-app': 'profile',
    'kdeconnect-sms': 'profile',
    UserFeedbackConsole: 'checklist',
    'drkonqi-coredump-gui': 'checklist',
    partitionmanager: 'nemo',
    keepsecret: 'themes',
    kwalletmanager5: 'themes',
    kmenuedit: 'themes',
    'plasma-systemmonitor': 'system_monitor',
    ark: 'nemo',
    yelp: 'profile',
    '/usr/bin/spectacle': 'spectacle',
  spectacle: 'spectacle',
    'plasma-emojier': 'profile',
    info: 'profile',
};
