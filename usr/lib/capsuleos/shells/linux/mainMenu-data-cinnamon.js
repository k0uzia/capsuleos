/**
 * Catalogue menu Cinnamon / Linux Mint uniquement.
 * Ne pas charger dans les skins GNOME, KDE ou COSMIC.
 */
const MENU_CATS = [
...
const MENU_APPS = [
    ...
    { catId: 'access',   icon: './assets/images/toolkits/cinnamon/apps/accessories-text-editor.png',     name: 'Éditeur de texte',            desc: 'Éditez des fichiers texte',                dataLink: 'text_editor' },
