...
const linuxPlanned = [
  ...
  S('linux-rocky', { family: 'linux', vendor: 'rocky', displayName: 'Rocky Linux (GNOME)', tier: 'P3', status: 'planned', maturity: 0, toolkit: 'gnome', shell: 'gnome-shell', fileManager: 'Fichiers', skills: ['os-linux'] }),
