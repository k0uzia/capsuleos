...
const profiles = [
  ...
  { id: 'linux-rocky', bodyId: 'rocky', vendor: 'rocky', displayName: 'Rocky Linux (GNOME)', tier: 'P3', facade: 'OS/linux/families/redhat/rocky/index.html', skin: 'home/RedHat/Rocky/index.html', toolkit: 'gnome', explorerTemplate: 'nemo-gnome', explorerName: 'Fichiers', embedKey: 'rocky', checklistKey: 'rocky-checklist', terminalProfile: 'rocky', explorerSkinKey: 'nautilus' },
  ...
  { id: 'linux-kde-neon', bodyId: 'kde-neon', vendor: 'neon', displayName: 'KDE neon User Edition', tier: 'P2', facade: 'OS/linux/families/debian/kde-neon/index.html', skin: 'home/Debian/KDE-Neon/index.html', toolkit: 'kde', explorerTemplate: 'dolphin', explorerName: 'Dolphin', embedKey: 'kde-neon', kde: true, templateOverrides: { update_manager: `${APPS}/update_manager_kde_neon.html` } },
  { id: 'linux-opensuse', bodyId: 'opensuse', vendor: 'opensuse', displayName: 'openSUSE Tumbleweed', tier: 'P1', facade: 'OS/linux/families/suse/opensuse/index.html', skin: 'home/SUSE/openSUSE/index.html', toolkit: 'kde', explorerTemplate: 'dolphin', explorerName: 'Dolphin', embedKey: 'opensuse', kde: true, terminalProfile: 'suse', templateOverrides: { update_manager: `${APPS}/update_manager_kde.html` } },
...
const buildProfiles = spawnSync(process.execPath, [path.join(__dirname, 'build-skin-profiles.mjs')], {
  cwd: ROOT,
  stdio: 'inherit',
});
if (buildProfiles.status !== 0) {
  process.exit(buildProfiles.status || 1);
}
